...
async function submitForm(e, form) {
    ...
    const response = await fetchService.performPostHttpRequest("https://script.google.com/macros/s/AKfycbxLE4-r1hNrjm6aD3hvju9XSXBiCm17fXW_WUlQ4SGvx-Ymu4oHxS2CbsOngNvn5Lk/exec", headers, jsonFormData); // Uses JSON Placeholder
...
/*--Event Listeners--*/
const sampleForm = document.querySelector("#myForm");
if(sampleForm) {
